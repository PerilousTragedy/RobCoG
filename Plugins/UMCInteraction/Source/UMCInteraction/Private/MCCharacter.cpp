...
AMCCharacter::AMCCharacter()
{
	...
	// Add the arm animation component
	UArmAnimComponent* ArmAnimationComponent = CreateDefaultSubobject<UArmAnimComponent>(TEXT("ArmAnimationComponent"));
	ArmAnimationComponent->GetOwner()->AddInstanceComponent(ArmAnimationComponent);
	AddOwnedComponent(ArmAnimationComponent);
}
...
void AMCCharacter::BeginPlay()
{
	...
	// Add the component used to animate arms
	//AddOwnedComponent(CreateDefaultSubobject<UArmAnimComponent>(TEXT("ArmAnimationComponent")));
	...
	if (LeftSkelActor)
	{	
		// Cast the hands to AMCHand
		LeftHand = Cast<AMCHand>(LeftSkelActor);
	...
	{
		// Cast the hands to AMCHand
		RightHand = Cast<AMCHand>(RightSkelActor);
