...
class VRARMSTRACKING_API UArmAnimInstance : public UAnimInstance
{
	GENERATED_BODY()
public:
	APawn* OwningPawn;
	UArmAnimComponent* ArmAnimPawnComponent;
	...
	*/
	FVector CalculateOffset(bool bIsRightHand, UArmAnimComponent * CurrentPawn, FVector EffectorLocation);
...
private:
	UArmAnimComponent* GetArmAnimComponent();
};
